...
python _2_DDIM_inv.py --input_image images/rendered_stool.jpg --results_folder ./output/rev_brown_chair_onto_stool && python _3_dpl_seg_inv.py --input_image images/rendered_stool.jpg --results_folder output/rev_brown_chair_onto_stool --initializer_token chair --placeholder_token  '<chair>' --smooth_op --softmax_op --seg_dirs seg_dirs/rendered_stool --exp_name rev_brown_chair_onto_stool --input_embs_path output/rev_brown_chair_yes_threshold/embed_list/rev_brown_chair_yes_threshold-cos_al_50.0_beta_0.7_lam_1.0_iou_al_25.0_beta_0.7_lam_1.0_kl_al_25.0_beta_1.0_lam_1.0_adj_al_50.0_beta_0.1_lam_2.0_softmax_True_smooth_True_null_31_attn_31_CFG_7.5_adj_False/chair1