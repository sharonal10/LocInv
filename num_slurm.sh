...
python _2_DDIM_inv.py --input_image images/rendered_chair.jpg --results_folder ./output --num_ddim_steps 50 && python _3_dpl_seg_inv.py --input_image images/rendered_chair.jpg --results_folder output/rendered_chair --max_iter_to_alter 0 --initializer_token chair --placeholder_token  '<chair>'  --lam_cos 2.0 --lam_iou 2.0 --lam_kl 2.0 --lam_adj 0.0 --smooth_op --softmax_op --seg_dirs seg_dirs/rendered_chair --target_image images/chair_green.jpg --num_ddim_steps 100 --exp_name one_word_green_latents --attn_inner_steps 50 