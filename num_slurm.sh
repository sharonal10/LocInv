...
--job "07-28-locinv-chair" --command "python _2_DDIM_inv.py --input_image images/rendered_chair.jpg --results_folder ./output --num_ddim_steps 20 && python _3_dpl_seg_inv.py --input_image images/rendered_chair.jpg --results_folder output/rendered_chair --max_iter_to_alter 0 --placeholder_token one two three four five six --initializer_token  '<one>'  '<two>'  '<three>'  '<four>'  '<five>'  '<six>' --lam_cos 1.0 --lam_iou 1.0 --lam_kl 1.0 --smooth_op --softmax_op --seg_dirs seg_dirs/chair --target_image images/chair.jpg --num_ddim_steps 20" $GPU_INFO