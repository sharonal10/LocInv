...
python _2_DDIM_inv.py --input_image images/green_chair.jpg --results_folder ./output/rev_rendered_chair && python _3_dpl_seg_inv.py --input_image images/green_chair.jpg --results_folder output/rev_rendered_chair --initializer_token chair --placeholder_token  '<chair>' --smooth_op --softmax_op --seg_dirs seg_dirs/rendered_chair --exp_name reverted_green_chair 